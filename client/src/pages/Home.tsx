...
<section className="px-6  bg-[#0A071A] text-white">
  <div className="max-w-5xl mx-auto text-center">
    ...
    <div className="flex flex-wrap justify-center gap-10 items-center">
      <img src="/public/logos/google.svg" alt="Google" className="h-8  hover:opacity-100 transition"  style={{ filter: "invert(1)" }}/>
      <img src="/public/logos/meta.svg" alt="Meta" className="h-8 grayscale opacity-80 hover:opacity-100 transition"  style={{ filter: "invert(1)" }}/>
      <img src="/public/logos/amazon.svg" alt="Amazon" className="h-8 grayscale opacity-80 hover:opacity-100 transition"  style={{ filter: "invert(1)" }} />
      <img src="/public/logos/microsoft-alt-svgrepo-com.svg" alt="Microsoft" className="h-8  grayscale opacity-80 hover:opacity-100 transition"  style={{ filter: "invert(1)" }}/>
      <img src="/public/logos/netflix-svgrepo-com.svg" alt="Netflix" className="h-8 grayscale opacity-80 hover:opacity-100 transition"  style={{ filter: "invert(1)" }} />
      <img src="/public/logos/stripe.svg" alt="Stripe" className="h-8 grayscale opacity-80 hover:opacity-100 transition"  style={{ filter: "invert(1)" }}/>
    </div>
  </div>
</section>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 mt-16 px-6 bg-[#050020] text-white">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
  Everything You Need to Get Hired
</h2>
<p className="text-center font-bold max-w-xl mx-auto mb-16 text-base text-gray-400">
  HireGen offers AI-powered mock interviews, resume creation, and in-depth resume analysis — all in one seamless platform.
</p>
    ...
    {/* Right Tall Card */}
          ...
          <div className="h-2/4 w-full flex items-center justify-center">
            ...
            <div className="bg-[#F0A7C3]/70  p-5 rounded-b-[4rem] text-white font-semibold w-full text-center h-2/4">
              ...
              <p className="font-normal text-[15px] mt-2 ">
                Create polished, job-winning resumes in minutes. Choose from expertly designed templates and let AI guide you through every section with smart content suggestions.
                </p>
      </div>
    </div>
  </div>
